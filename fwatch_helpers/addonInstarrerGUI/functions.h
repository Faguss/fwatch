...
INSTALLER_ERROR_CODE Download(std::wstring url, int options=FLAG_NONE, std::wstring file_name_to_log=L"");
INSTALLER_ERROR_CODE DownloadCore(std::wstring url, int options=FLAG_NONE, std::wstring file_name_to_log=L"");
